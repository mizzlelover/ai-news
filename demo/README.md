...
这是仓库唯一的面向使用者的产品入口。它解释私人情报所为什么存在、首先服务哪些人、如何从一个领域关键词开始，以及同一套方法如何先建立领域知识域，再进入文旅、制造、教育和个人专业现场的具体问题。

演示站面对两类使用者：第一类是刚进入某个领域、没有知识背景、不知道该看谁和该信谁的人；第二类是已经在领域里、手上有一些专业信源但覆盖还不够广的人。两类人都要先建立领域的边界、专家、信源和知识结构，之后才使用工具更新信息、生成日报、推送变化和维护知识引擎。
