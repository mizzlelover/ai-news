const domainData = {
  "digital-tourism": {
    name: "数字文旅产业",
    summary: "示例先展示这个领域由什么组成、谁在持续产生信息、哪些来源值得长期跟清楚，再决定你要深入哪一条线。",
    map: "政策与规则 · 技术与产品 · 项目与场景 · 市场与运营",
    people: "主管部门 · 平台企业 · 项目运营者 · 研究者",
    sources: "政策原文 · 项目/招采 · 厂商一手 · 行业解释",
    engine: "领域知识域 + 人物/机构图 + 来源组合 + 每日简报",
    next: "示例先展示领域底图；真实运行时再进入更新与具体问题追踪",
  },
  robotics: {
    name: "机器人产业",
    summary: "示例先分清本体、核心零部件、模型、场景和交付链，再看哪些方向真的在落地。",
    map: "本体与零部件 · 模型与控制 · 场景应用 · 供应链与交付",
    people: "研发团队 · 厂商与集成商 · 下游客户 · 标准与研究机构",
    sources: "标准原文 · 产品发布 · 招投标/客户 · 工程实践",
    engine: "领域知识域 + 产业链图 + 产品/项目档案 + 每日简报",
    next: "示例先展示产业链底图；真实运行时再进入长期观察",
  },
  "low-altitude": {
    name: "低空经济",
    summary: "示例先展示政策、基础设施、飞行器、运营场景和监管要求之间的全景关系。",
    map: "政策与空域 · 飞行器与设施 · 运营场景 · 安全与监管",
    people: "主管部门 · 飞行器企业 · 运营方 · 空域与安全专家",
    sources: "政策/标准 · 试点项目 · 企业一手 · 运营数据",
    engine: "领域知识域 + 政策图谱 + 项目与主体档案 + 每日简报",
    next: "示例先展示领域底图；真实运行时再跟踪重点应用方向",
  },
  education: {
    name: "职业教育",
    summary: "示例先展示政策、学校、专业、课程、企业需求和就业结果如何连成一条教育链。",
    map: "政策与专业 · 学校与课程 · 企业需求 · 教师与学习结果",
    people: "教育主管部门 · 学校与教师 · 用人企业 · 研究者",
    sources: "政策原文 · 学校实践 · 企业招聘 · 研究解释",
    engine: "领域知识域 + 学校/企业图 + 实践证据库 + 每日简报",
    next: "示例先展示教育链底图；真实运行时再深入专业方向",
  },
};
