(function () {
  ...
  const validation = globalThis.PrivateIntelligenceWorkbenchValidation;
  if (!validation) throw new Error("工作台校验模块未加载");
  const { REQUIRED_RUN_JSON, normalizePath, hasUnsafePath, isRecord, validateImportedRun } = validation;
